      ...
      <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full rounded-xl border py-2.5 pl-10 pr-3.5 text-sm text-slate-900 transition-colors focus:outline-hidden ${
                errors.name
          ...
          {errors.name ? (
            ...
            <p className="text-[11px] text-slate-400">Official student name for placement verification.</p>
          )}
        </div>
        ...
        <div className="space-y-1.5">
          ...
          {errors.email ? (
            ...
            <p className="text-[11px] text-slate-400">Used for interview invites and offer letter deliveries.</p>
          )}
        </div>
        ...
        <div className="space-y-1.5">
          ...
          {errors.phone ? (
            ...
            <p className="text-[11px] text-slate-400">Include country code for recruiter phone calls.</p>
          )}
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full appearance-none rounded-xl border border-slate-200 bg-white py-2.5 pl-10 pr-8 text-sm text-slate-900 transition-colors focus:border-[#6366F1] focus:outline-hidden focus:ring-3 focus:ring-indigo-500/15"
            >
          ...
          <p className="text-[11px] text-slate-400">Selected engineering / discipline branch.</p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[11px] text-slate-400">Current ongoing study year.</p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          {errors.cgpa ? (
            ...
            <p className="text-[11px] text-slate-400">Must be between 0.0 and 10.0 scale.</p>
          )}
        </div>
        ...
        <div className="space-y-1.5 sm:col-span-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white py-2.5 pl-10 pr-3.5 text-sm text-slate-900 transition-colors focus:border-[#6366F1] focus:outline-hidden focus:ring-3 focus:ring-indigo-500/15"
            />
          </div>
          <p className="text-[11px] text-slate-400">Your current city / location preference for job postings.</p>
        </div>
        ...
        <div className="space-y-1.5 sm:col-span-2">
          <div className="flex items-center justify-between">
            ...
            <span
              className={`text-[11px] font-semibold ${
                bioLength > maxBioLength ? "text-rose-600" : "text-slate-400"
              }`}
            >
          ...
          <div className="relative">
            <textarea
              ...
              className={`w-full rounded-xl border p-3.5 text-sm text-slate-900 transition-colors focus:outline-hidden ${
                errors.bio
                  ? "border-rose-400 bg-rose-50/30 focus:border-rose-500 focus:ring-3 focus:ring-rose-500/10"
                  : "border-slate-200 bg-white focus:border-[#6366F1] focus:ring-3 focus:ring-indigo-500/15"
              }`}
